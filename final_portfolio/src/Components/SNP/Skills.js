    ...
    <div id="snp">
      ...
      <Marquee gradient={false}>
        <div className={classes.marqueeContainer}>
          <div><img height="100" src={python} /></div>
          <div><img height="100" src={javascript} /></div>
          <div><img height="100" src={html} /></div>
          <div><img height="100" src={css} /></div>
          <div><img height="100" src={reactLogo} /></div>
          <div><img height="100" src={bootstrap} /></div>
          <div><img height="100" src={tailwind} /></div>
          <div><img height="100" src={tf} /></div>
          <div><img height="100" src={cv} /></div>
          <div><img height="100" src={mysql} /></div>
          <div><img height="100" src={mongodb} /></div>
          <div><img height="100" src={gitIcon} /></div>
        </div>
      </Marquee>
    </div>
  );

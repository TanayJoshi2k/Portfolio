  ...
  return (
    <div>
      ...
      <div className={classes.projectsContainer}>
        ...
        <div className={classes.project}>
          <a href="" target="_blank" rel="noopener noreferrer">
            Image Super Resolution using ResNet + GAN
          </a>
        ...
        <div className={classes.project}>
          ...
          <div className={classes.imgContainer}>
            <p>Personal site made with React</p>
          </div>
          <div className={classes.techStackContainer}>
            <div className={classes.techStack}>
              <div>HTML</div>
        ...
        <div className={classes.project}>
          <a href="https://github.com/TanayJoshi2k/Pokedex" target="_blank" rel="noopener noreferrer">
            Pokedex
          </a>
        ...
        <div className={classes.project}>
          ...
          <div className={classes.imgContainer}>
            <p>
              Built an Instagram clone with React and Firebase that allows users
              to signup & login, follow, unfollow accounts, upload and comment on posts.
            </p>
          </div>
